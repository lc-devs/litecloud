...
var tblSORerefenceBody = GetDomElement("tblSORerefenceBody");
...
GetDomElement('radioRecievedByLogistics').addEventListener('click', function () {
    ...
    // /* REMOVE ON SERVICE INTEGRATION */
    // tblBody.innerHTML = "";
    // tblBody.innerHTML +=
    //     "<tr> " +
    //     "<td class='border col-4'>254235</td>" +
    //     "<td class='border col-8 text-left'>Metro Centre Hotel</td>" +
    //     "</tr>";
...
function TagAsCompleteLaundry(soReference) {
    ...
    GetDomElement("btnConfirmTwo").onclick = ()=>{
        var doneItem = InvokeService(GetURL(), `LogisticIndustrialMethods/completeditembylaundry/${soReference}`, "POST", "");
