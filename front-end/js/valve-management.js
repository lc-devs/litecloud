...
function populateBrandItemTable() {
    ...
    var jsonData = InvokeService("Inventory_ModelsMethods/description/" + brandSearchInput + "?type=5", "GET", "");
...
function UpdateBrandName() {
 ...
 var objParam={
   ...
   var response = InvokeService("Inventory_ModelsMethods/id?type=5", "PUT", paramBody);
...
function addNewBrand(){
 ...
 var objParam={
   ...
   var response = InvokeService("Inventory_ModelsMethods?type=5", "POST", paramBody);
 //getting the paramBody 
...
function DeleteBrandName() {
    ...
    var oldBrandID = document.getElementById("brandID").value;
    //declaring the value of the paramBody...
      var response = InvokeService("Inventory_ModelsMethods/id?id=" + oldBrandID + "&type=5" , "DELETE");
    //getting the paramBody 
