...
var engineadditives = document.getElementById("engine-additives");
var brandinput = document.getElementById("brand-input");
var itemdesinput = document.getElementById("valve-input");
var stuinput = document.getElementById("stu-input");
var rtuinput = document.getElementById("rtu-input");
var ratioinput = document.getElementById("ratio-input");
var avecostinput = document.getElementById("avecost-input");
...
var valvetype = document.getElementById("valve-input").value;
...
var spriceinput = document.getElementById("sprice-input").value;
    ...
    if (response.code == 200) {
        ...
        var valves = JSON.parse(data.jsonData);
...
function GetValvetype(){
    ...
    var response = InvokeService("Inventory_ModelsMethods/getall?type=5", "GET", "");
    console.log(response);

    if (response.code == 200) {

        inputvalve = document.getElementById("valve-input");
        inputvalve.innerHTML = "";

        var data = JSON.parse(response.data);
    
        var valvetype = JSON.parse(data.jsonData);
    
        valvetype.innerHTML += "<option value=\"" + "" + "\">" + "Please select" + "</option>";
    
        for (var i = 0; i < valvetype.length; i++) {
            PopulateDropdownList(inputvalve, valvetype[i].id, valvetype[i].description, valvetype[i].user_id, valvetype[i].entry_date);
        }
