    ...
    //Purpose: Use to validate the inputs in the inventory-other-items page form. This serves as the function for form validation.
    //Author: James Carl Sitsit
    //Parameter:
    //  Name                 Comment
    //  -----------          --------------------------------
    ...
    //Purpose: Use to validate the number input. This function will not a
    //Author: James Carl Sitsit
    //Parameter:
    //  Name                Comment
    //  -----------         --------------------------------
    ...
    function populateBrands(){
        var brandResponse = InvokeService("Inventory_BrandsMethods/getall", "GET", "");
