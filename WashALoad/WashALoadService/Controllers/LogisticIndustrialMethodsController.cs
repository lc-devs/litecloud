...
namespace WashALoadService.Controllers
{
    ...
    public class LogisticIndustrialMethodsController : Controller
    {
        ...
        public LogisticIndustrialMethodsController()
        {
        ...
        public async Task<IActionResult> LaundryQueryReportByDate(string dateFrom, string dateTo, int customerID, LaundryStatus laundry, [FromHeader] string UserKey)
        {
            ServiceResponse serviceResponse = new ServiceResponse();
            try
            {
                ...
                serviceResponse = await oEntity.LaundryQueryReportByDate(dateFrom, dateTo, customerID, laundry);
        ...
        public async Task<IActionResult> ReceivedItemByLogisticssAsync([FromBody] LogisticIndustrial logisticIndustrial, [FromHeader] string UserKey)
        {
            ServiceResponse serviceResponse = new ServiceResponse();
            try
            {
                ...
                serviceResponse = await oEntity.ReceivedItemByLogisticssAsync(logisticIndustrial);
        ...
        //public async Task<IActionResult> GenerateBillingAsync([FromBody] List<Int32> customerIDs, [FromHeader] string UserKey)
        //    {
        //        ServiceResponse serviceResponse = new ServiceResponse();
        //        try
        //        {
        ...
        //            //serviceResponse = await oEntity.GenerateBillingAsync(customerIDs, systemUser.user_id);
