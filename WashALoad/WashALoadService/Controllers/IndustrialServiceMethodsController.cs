...
namespace WashALoadService.Controllers
{
    ...
    public class IndustrialServiceMethodsController : Controller
    {
        ...
        public IndustrialServiceMethodsController()
        {
        ...
        public async Task<IActionResult> FindAllAsync([FromHeader] string UserKey)
        {
            ...
            try
            {
                ...
                var oEntity = new IndustrialServiceMethods(gDb);
        ...
        [HttpPost]
        public async Task<IActionResult> SaveServiceAsync([FromBody] IndustrialService service, [FromHeader] string UserKey)
        {
            ServiceResponse serviceResponse = new ServiceResponse();
            try
            {
        ...
        [HttpPut("{serviceId}")]
        public async Task<IActionResult> UpdateServiceAsync([FromBody] IndustrialService service, [FromHeader] string UserKey)
        {
            ServiceResponse serviceResponse = new ServiceResponse();
            try
            {
