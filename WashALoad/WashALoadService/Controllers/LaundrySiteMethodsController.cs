...
namespace WashALoadService.Controllers
{
    ...
    public class LaundrySiteMethodsController : Controller
    {
        ...
        public LaundrySiteMethodsController()
        {
        ...
        public async Task<IActionResult> FindAllAsync([FromHeader] string UserKey)
        {
            ...
            try
            {
                ...
                var oEntity = new LaundrySiteMethods(gDb);
        ...
        [HttpPost]
        public async Task<IActionResult> SaveSiteAsync([FromBody] LaundrySite site, [FromHeader] string UserKey)
        {
            ServiceResponse serviceResponse = new ServiceResponse();
            try
            {
        ...
        [HttpPut("{siteId}")]
        public async Task<IActionResult> UpdateSiteAsync([FromBody] LaundrySite site, [FromHeader] string UserKey)
        {
            ServiceResponse serviceResponse = new ServiceResponse();
            try
            {
