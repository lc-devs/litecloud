...
namespace WashALoadService.Controllers
{
    ...
    public class PickupIndustrialMethodsController : Controller
    {
        ...
        public PickupIndustrialMethodsController()
        {
        ...
        [HttpPost]
        public async Task<IActionResult> SavePickupItemsAsync([FromBody] PickupIndustrial pickupIndustrial, [FromHeader] string UserKey)
        {
            ServiceResponse serviceResponse = new ServiceResponse();
            try
            {
                ...
                serviceResponse = await oEntity.SavePickupItemsAsync(pickupIndustrial);
